...
namespace Flowrista_Admin.Controllers.Master
{
    public class SectionController : Controller
    {
        ...
        public SectionController(IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            return View("Views/Master/Section.cshtml");
        }
        public JsonResult CategoryDataTable()
        {
            ...
            SectionDatatableInputModel dataTableparam = new SectionDatatableInputModel()
            {
                IN_LIMITINDEX = 10,
            ...
            result.Data = "[\r\n  {\r\n    \"Id\": 3,\"CategoryName\": \"Section1\", \"ImagePath\": \"837efeab-f05b-4b65-b4b3-8ca9b4c329b2_Med_Bill1.jpeg\",\"IsActive\": true\r\n    \r\n  },\r\n  {\r\n    \"Id\": 4,\"CategoryName\": \"Section2\",\"ImagePath\": \"dd1ab639-2869-47e3-8237-0a88d59e4a51_Med_Bill1.jpeg\",\"IsActive\": true\r\n    \r\n  },\r\n  {\r\n    \"Id\": 5,\"CategoryName\": \"Section3\",\"ImagePath\": \"60628172-e7ef-425e-b996-f8d2fea0cc6a_USG.jpeg\",\"IsActive\": true    \r\n  },\r\n  {\r\n    \"Id\": 6,\"CategoryName\": \"Section4\", \"ImagePath\": \"e4fa1dca-e694-4ace-af1f-5cfe940399d9_Doctor Visit.jpeg\",\"IsActive\": false,\r\n    \r\n  }\r\n]  ";
            result.ReturnCode = "200";
            result.ReturnMessage = "Success";
            var dataTableData = new List<SectionDataTableViewmodel>();
            if (result != null && result.Data != null)
                dataTableData = (Newtonsoft.Json.JsonConvert.DeserializeObject<List<SectionDataTableViewmodel>>(Convert.ToString(result.Data)));
